...
function fileIcon($sName)
{
    ...
    $arMatrixExt = array(
    'excel' => array('xls', 'xlsx', 'xlsm', 'xlsb', 'xltm', 'xlam', 'xlt'),
    'film' => array('avi', 'wmv', 'mpg', 'mpeg', 'mkv', 'm2ts', '3gp', 'dat', 'm4v', 'mov', 'rm', 'vob'),
    'flash-movie' => array('flv'),
    'flash' => array('swf', 'fla'),
    'globe' => array('html', 'htm', 'xml', 'xls'),
    'illustrator' => array('ai', 'eps'),
    'image' => array('jpg', 'jpeg', 'gif', 'png', 'bmp', 'tif', 'tiff'),
    'music' => array('mp3', 'amr', 'ape', 'bin', 'flac', 'm4a', 'mdi', 'ram'),
    'office' => array('ppsx', 'pptm', 'pptx', 'xlsm'),
    'outlook' => array('eml', 'dbx', 'nch', 'ods', 'ost'),
    'pdf' => array('pdf'),
    'photoshop' => array('psd'),
    'php' => array('php', 'php3', 'php4', 'php5', 'phtml'),
    'powerpoint' => array('ppt', 'pot', 'pps'),
    'text' => array('sql', 'db', 'rtf', 'ini', 'txt', 'log'),
   	'word' => array('doc', 'docx', 'dotx', 'odt'),
    'zipper' => array('zip', 'rar', '7z', 'z', 'tag', 'gz', 'tgz', 'arj', 'lha', 'uc2', 'ace', 'zix', 'w02', '7zip')
    );
...
function fileInfo($nID)
{
	global $DB;
	if($arRows = $DB->Rows("SELECT * FROM `k2_file` WHERE ID = '".(int)$nID."'")){
		$arRows[0]['PATH'] = '/files/'.$arRows[0]['PATH'];
		return $arRows[0];
	}
	return false;
}
...
{
	$arMatrix = array('а' => 'a', 'б' => 'b', 'в' => 'v', 'г' => 'g', 'д' => 'd','е' => 'e', 'ё' => 'e', 'ж' => 'zh',  'з' => 'z', 'и' => 'i', 'й' => 'y','к' => 'k', 'л' => 'l', 'м' => 'm','н' => 'n','о' => 'o', 'п' => 'p','р' => 'r', 'с' => 's', 'т' => 't','у' => 'u', 'ф' => 'f', 'х' => 'h','ц' => 'c', 'ч' => 'ch', 'ш' => 'sh',  'щ' => 'sch', 'ь' => "'", 'ы' => 'y','ъ' => "'", 'э' => 'e', 'ю' => 'yu', 'я' => 'ya', 'А' => 'A','Б' => 'B','В' => 'V', 'Г' => 'G','Д' => 'D','Е' => 'E', 'Ё' => 'E','Ж' => 'Zh',  'З' => 'Z', 'И' => 'I','Й' => 'Y','К' => 'K', 'Л' => 'L','М' => 'M','Н' => 'N', 'О' => 'O','П' => 'P','Р' => 'R', 'С' => 'S', 'Т' => 'T', 'У' => 'U', 'Ф' => 'F', 'Х' => 'H', 'Ц' => 'C', 'Ч' => 'Ch', 'Ш' => 'Sh', 'Щ' => 'Sch', 'Ь' => "'", 'Ы' => 'Y', 'Ъ' => "'", 'Э' => 'E', 'Ю' => 'Yu', 'Я' => 'Ya');
