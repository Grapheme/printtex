...
<div class="content">
    ...
    <table width="100%" class="nav">
    	<tr>
            <td align="right"><a href="#" onclick="return $.layer({get:'/k2/admin/dev/field/separator/add.php?table=k2_user', title:'Добавить разделитель', w:397}, function(){k2.group.add()})" class="button">Добавить разделитель</a><a href="add.php" class="button">Добавить поле</a></td>
        </tr>
    </table>
