...
tab_(array(array('Для сайта', '/dev/field/site/', 1), array('Для разделов', '/dev/field/section/'), array('Для пользователей', '/dev/field/user/')));
?>
<div class="content">
	<h1>Список полей</h1>
    <table width="100%" class="nav">
    	<tr>
            <td align="right"><a href="#" onclick="return $.layer({get:'/k2/admin/dev/field/separator/add.php?table=k2_site', title:'Добавить разделитель', w:397}, function(){k2.group.add()})" class="button">Добавить разделитель</a><a href="add.php" class="button">Добавить поле</a></td>
        </tr>
    </table>
   	<table width="100%" class="table">
    	...
    	<tbody class="sf-body"><?
    	if($arField = array_merge($LIB['FIELD']->Rows('k2_site'), $LIB['FIELD_SEPARATOR']->Rows('k2_site'))){        	usort($arField, 'sortArray');
