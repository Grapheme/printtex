...
tab_(array(array('Настройки', '/dev/block/edit.php?id='.$_ID), array('Поля категорий', '/dev/block/field/category/?id='.$_ID), array('Поля элементов', '/dev/block/field/element/?id='.$_ID, 1)));
