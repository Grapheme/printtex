...
tab_(array(array('Настройки', '/dev/block/edit.php?id='.$nBlock), array('Поля категорий', '/dev/block/field/category/?id='.$nBlock, 1), array('Поля элементов', '/dev/block/field/element/?id='.$nBlock)));
