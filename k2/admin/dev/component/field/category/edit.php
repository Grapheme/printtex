...
tab_(array(array('Настройки', '/dev/component/edit.php?id='.$nBlock), array('Поля категорий', '/dev/component/field/category/?id='.$nBlock, 1), array('Поля элементов', '/dev/component/field/element/?id='.$nBlock)));
...
?><div class="content">
	...
	<form action="edit.php?id=<?=$_ID?>" method="post" class="form">
		...
		?><div class="saveBlock">
			...
			<p><input type="submit" class="sub" value="Сохранить"> или <a href="/k2/admin/dev/component/field/category/?id=<?=$nBlock?>">отменить</a></p>
		</div>
	</form>
</div><?
