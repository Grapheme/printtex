...
{
	$DB->Query("UPDATE `k2_block".$USER['SETTING']['CATEGORY_MOVE']['BLOCK']."category` SET `SECTION_BLOCK` = '".$_SECTION_BLOCK."', `PARENT` = '".$_CATEGORY."' WHERE `ID` = '".$USER['SETTING']['CATEGORY_MOVE']['ID'][$i]."';");
}
