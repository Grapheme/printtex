...
<html>
	<head>
		<meta charset="utf-8">
		<link rel="stylesheet" type="text/css" href="/k2/admin/jc/auth.css">
        	...
        	<form method="post">
                <table>
                    <tr>
                        ...
                        <td><div class="icon"><div class="icon-login"></div></div><input type="text" name="AUTH_LOGIN" class="inp" autofocus value="<?=htmlspecialchars($_POST['AUTH_LOGIN'])?>"></td>
                        <td><div class="icon"><div class="icon-password"></div></div><input type="password" name="AUTH_PASSWORD" class="inp"></td>
                        <td><input type="submit" class="sub" value="Войти"></td>
                    </tr>
                    <tr>
                        <td class="copy">&copy; 2012</td>
