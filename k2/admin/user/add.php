...
<div class="content">
	...
	<form action="add.php" method="post" enctype="multipart/form-data" class="form">
	    ...
	    <div class="item">
	    	...
	    	<div class="field"><input type="text" name="LOGIN" value="<?=html($_POST['LOGIN'])?>" autofocus></div>
	    </div>
	    <div class="item">
	    	<div class="name">Пароль<span class="star">*</span></div>
	    	<div class="field"><input type="password" name="PASSWORD" value="<?=html($_POST['PASSWORD'])?>"></div>
	    </div>
	    <div class="item">
	    	<div class="name">Повтор пароля<span class="star">*</span></div>
	    	<div class="field"><input type="password" name="PASSWORD_RETRY" value="<?=html($_POST['PASSWORD_RETRY'])?>"></div>
	    </div>
	    <div class="item">
