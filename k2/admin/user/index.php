...
<div class="content">
    ...
    ?><table width="100%" class="nav">
    	<tr>
        	<td><?=$sNav?></td>
            <td align="right"><a href="#" onclick="return $.layer({get:'setting.php', title:'Настройки отображения', w:600}, function(){table.sort(-1, 'sf-body');})" class="button">Настройки отображения</a><a href="add.php" class="button">Добавить пользователя</a></td>
        </tr>
    </table>
    ...
    <table width="100%" class="select">
    	<tr>
            ...
            $('#action').change(function(){            	val = $(this).val();
            	...
            	data = $('#form').serialize();
                if(data.length){                	if(val == 'delete'){                		$.prompt(this, {'href':'/k2/admin/user/', 'yes':'return actionDelete(1)', 'no':'return actionDelete(0)'});
                	}
                }
            });
